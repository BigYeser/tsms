    ...
    >
      <g id="Layer_1_1_" class="st0">
        <g class="st1">
          <path
            class="st2"
            d="M61.8,67.7c-1.7,6.1-5.3,16.1-7.6,20.2c-3.8,0.9-15.3,3.7-25,3.7c-33.6,0-48.6-22.2-48.6-42.4
          ...
          <path
            class="st2"
            d="M79.3,91c-4.3,0-7.5-3-7.5-7.8c0-4.3,3.2-7.6,7.7-7.6s7.6,3.3,7.6,7.6c0,4.9-3.1,7.8-7.6,7.8H79.3z"
          />
          <path
            class="st2"
            d="M144,45c13.3,1.7,23.5,7.3,23.5,20.1c0,8.5-4.7,15.2-12.4,19.3c-6.7,3.6-15.6,5.1-26,5.1h-30v-3.7
			c11.2-0.8,12-1.7,12-12.4V22.9c0-10.9-0.6-11.7-10.9-12.4V6.7h34.5c9.9,0,15.6,1.5,20,4.4c4.5,3.1,7.3,8.6,7.3,14.6
			c0,12.1-10.5,17.1-18.1,18.9L144,45L144,45z M129,43.4c14.1,0,20-5.5,20-16c0-9.1-5.1-16.4-17-16.4c-3.1,0-6.1,0.7-7.2,1.6
			c-1.1,0.8-1.5,2.3-1.5,6.2v24.7h5.7V43.4z M123.3,73.2c0,9.5,2.5,11.9,10.7,11.9c10.2-0.2,19.4-5.4,19.4-18.6
			c0-12.8-8.9-18.6-24.7-18.6h-5.4C123.3,47.9,123.3,73.2,123.3,73.2z"
          />
        </g>
        <g class="st1">
          <path
      ...
      <g id="Layer_2_1_">
        <text transform="matrix(1 0 0 1 -9.765625e-04 90.2051)" class="st2 st3 st4">
          CL
        </text>
      </g>
    </svg>
