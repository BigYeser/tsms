...
class OrderCreated extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->greeting('By clicking on the button below, you agree to the following terms and conditions')
            ...
            ->greeting('بالنقر فوق الزر أدناه ، فإنك توافق على الشروط والأحكام التالية')
