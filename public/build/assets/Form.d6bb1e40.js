...
`);else{const u=r.ids.size-1,l=document.createTextNode(s),f=r.element.childNodes;f[u]&&r.element.removeChild(f[u]),f.length?r.element.insertBefore(l,f[u]):r.element.appendChild(l)}}}const En=gn;var ve=function(){var e=this.$createElement,n=this._self._c||e;return n("div",[n("form",{attrs:{id:"stripe-element-form"}},[n("div",{attrs:{id:"stripe-element-mount-point"}}),this._v(" "),this._t("stripe-element-errors",[n("div",{attrs:{id:"stripe-element-errors",role:"alert"}})]),this._v(" "),n("button",{ref:"submitButtonRef",staticClass:"hide",attrs:{type:"submit"}})],2)])},wn=[];ve._withStripped=!0;const Sn=function(e){e&&e("data-v-4dd8360e_0",{source:`
...
`]},media:void 0})},Tn=ye({render:be,staticRenderFns:Pn},On,kn,"data-v-3329b3f8",!1,void 0,!1,ge,void 0,void 0);var In={install:function(e,n){var t,r,s,u,l,f,w;return C.async(function(p){for(;;)switch(p.prev=p.next){case 0:t=n.pk,r=n.stripeAccount,s=n.apiVersion,u=n.locale,l=n.elementsOptions,(f=window.Stripe(t,{stripeAccount:r,apiVersion:s,locale:u})).registerAppInfo(X),w=f.elements(l),e.prototype.$stripe=f,e.prototype.$stripeElements=w;case 6:case"end":return p.stop()}})}};H.StripeCheckout=pn,de=H.StripeElementCard=An,H.StripeElementPayment=Tn,H.StripeElementsPlugin=In,H.StripePlugin=Ze;const jn={remember:"form",components:{CheckboxInput:_e,LoadingButton:Ce,TextInput:Se,TextareaInput:Ae,StripeElementCard:de},props:{modal:Boolean,c:Object,icustomers:Array,amount:Number,oId:{default:!1}},data(){return{loading:!1,sending:!1,form:{date:null,reference:null,amount:null,gateway:null,received:null,order_id:null,customer_id:null,token:null,token_id:null,description:null},paid:0,errors:{},error:null,gateways:[],customers:[],message:null,customer:null,publishableKey:null}},mounted(){this.customers=this.icustomers||[],console.log("Hello"),this.oId?this.$axios.post(this.route("payments.order",this.oId)).then(({data:e})=>this.paid=e.reduce((n,t)=>n+parseFloat(t.amount),0)).then(()=>{this.amount&&(this.form.amount=this.$number(this.amount-this.paid)+"")}).catch(e=>console.log(e)):this.amount&&(this.form.amount=this.$number(this.amount)+""),console.log("Hello2"),this.form.date=new Date().toISOString().split("T")[0],this.gateways=this.$page.props.user.account.gateways.split(","),this.c&&(this.customers.push(this.c),this.form.customer_id=this.c.value,this.customer=this.c),this.$page.props.user.account.payu&&this.gateways.push("PayU"),console.log("Hello3"),this.$page.props.user.account.stripe&&(this.gateways.push("Stripe"),this.publishableKey=this.$page.props.user.account.stripe_key),console.log("Hello4")},methods:{customerChanged(e){console.log(e),this.customer=e||null,this.form.customer_id=e?e.value:null},searchCustomers(e,n){e&&(n(!0),this.searchingCustomers(n,e,this))},searchingCustomers:we((e,n,t)=>{fetch(t.route("ajax.customers")+"?search="+escape(n)).then(r=>{r.json().then(s=>t.customers=s),e(!1)})},350),submit(){this.sending=!0,this.form.gateway=="Stripe"&&!this.form.token_id?this.$refs.stripeCard.submit():this.$axios.post(this.route("payments.store"),this.form).then(e=>{this.sending=!1,e.data.success&&(e.data.payu&&(window.location.href=this.route("payu.request",e.data.id)),this.modal?this.$emit("close"):(this.form={date:new Date,reference:null,amount:null,gateway:null,received:null,order_id:null,customer_id:null,token:null,token_id:null,description:null},this.customer=null))}).catch(e=>{this.sending=!1,this.form.token=null,this.form.token_id=null,this.errors=e.response.data.errors,this.$page.props.flash.error=e.response.data.message,this.$nextTick(()=>{document.getElementById("page-contents").scrollTop=0})})},tokenCreated(e){this.form.token=e,this.form.token_id=e.id,this.submit()}}},Ln={class:"ltr:text-left rtl:text-right"},Rn={key:0,class:"np flex justify-between items-center px-6 py-4 mb-4 bg-gray-100 border-b rounded-t"},Bn={class:"font-bold flex-1"},Dn={class:"flex items-center"},$n=g("svg",{class:"fill-current text-black",xmlns:"http://www.w3.org/2000/svg",width:"18",height:"18",viewBox:"0 0 18 18"},[g("path",{d:"M14.53 4.53l-1.06-1.06L9 7.94 4.53 3.47 3.47 4.53 7.94 9l-4.47 4.47 1.06 1.06L9 10.06l4.47 4.47 1.06-1.06L10.06 9z"})],-1),Fn=[$n],Vn={class:"p-8 ltr:-mr-6 rtl:-ml-6 ltr:ml-0 rtl:mr-0 -mb-8 flex flex-wrap"},Nn={class:"ltr:pr-6 rtl:pl-6 pb-8 w-full lg:w-1/2"},Un={class:"form-label",for:"gateway"},Mn={key:0,class:"form-error"},Gn={class:"ltr:pr-6 rtl:pl-6 pb-8 w-full"},Hn={class:"form-label",for:"customer_id"},qn={key:0,class:"form-error"},zn={class:"px-8 pb-8 ltr:-mr-6 rtl:-ml-6 ltr:ml-0 rtl:mr-0 -mb-8 flex flex-wrap"},Yn={key:0,class:"w-full"},Xn={for:"card-element"};function Kn(e,n,t,r,s,u){var y,B,k,T,b,D,I;const l=U("text-input"),f=U("v-select"),w=U("textarea-input"),p=U("stripe-element-card"),v=U("checkbox-input"),S=U("loading-button");return t.c?(M(),z("div",{key:0,class:G(t.modal?"modal flex items-center w-full h-full":"")},[g("div",{class:G(t.modal?"bg-white w-full rounded shadow-lg max-w-2xl mx-auto my-auto animate zoomIn":"")},[g("div",Ln,[t.modal?(M(),z("div",Rn,[g("p",Bn,L(e.$t("add_x",{x:e.$tc("Payment")})),1),g("div",Dn,[g("a",{class:"modal-close cursor-pointer z-50",onClick:n[0]||(n[0]=m=>e.$emit("close"))},Fn)])])):Y("",!0),g("div",{class:G(t.modal?"print":"")},[g("form",{onSubmit:n[9]||(n[9]=ke((...m)=>u.submit&&u.submit(...m),["prevent"])),autocomplete:"off"},[g("div",Vn,[O(l,{type:"date",label:e.$t("Date"),modelValue:s.form.date,"onUpdate:modelValue":n[1]||(n[1]=m=>s.form.date=m),pattern:"\\d{4}-\\d{2}-\\d{2}",errors:(y=s.errors)==null?void 0:y.date,class:"ltr:pr-6 rtl:pl-6 pb-8 w-full lg:w-1/2"},null,8,["label","modelValue","errors"]),O(l,{label:e.$t("Reference"),modelValue:s.form.reference,"onUpdate:modelValue":n[2]||(n[2]=m=>s.form.reference=m),errors:(B=s.errors)==null?void 0:B.reference,class:"ltr:pr-6 rtl:pl-6 pb-8 w-full lg:w-1/2"},null,8,["label","modelValue","errors"]),O(l,{step:"0.01",type:"number",label:e.$t("Amount"),modelValue:s.form.amount,"onUpdate:modelValue":n[3]||(n[3]=m=>s.form.amount=m),errors:(k=s.errors)==null?void 0:k.amount,class:"ltr:pr-6 rtl:pl-6 pb-8 w-full lg:w-1/2"},null,8,["label","modelValue","errors"]),g("div",Nn,[g("label",Un,L(e.$t("Gateway")),1),O(f,{transition:"",clearable:!1,"input-id":"gateway",options:s.gateways,modelValue:s.form.gateway,"onUpdate:modelValue":n[4]||(n[4]=m=>s.form.gateway=m),dir:e.$user.account.direction,placeholder:e.$t("select_x",{x:e.$t("Gateway")}),class:G({error:s.errors.gateway&&s.errors.gateway.length})},null,8,["options","modelValue","dir","placeholder","class"]),(T=s.errors)!=null&&T.gateway?(M(),z("div",Mn,L(s.errors.gateway[0]),1)):Y("",!0)]),g("div",Gn,[g("label",Hn,L(e.$tc("Customer")),1),O(f,{transition:"",modelValue:s.customer,"onUpdate:modelValue":n[5]||(n[5]=m=>s.customer=m),clearable:!1,options:s.customers,"input-id":"customer_id",onInput:u.customerChanged,onSearch:u.searchCustomers,dir:e.$user.account.direction,"onOption:selected":u.customerChanged,placeholder:e.$t("search_x",{x:e.$tc("Customer")}),class:G({error:((b=s.errors)==null?void 0:b.customer_id)&&s.errors.customer_id.length})},null,8,["modelValue","options","onInput","onSearch","dir","onOption:selected","placeholder","class"]),(D=s.errors)!=null&&D.customer_id?(M(),z("div",qn,L(s.errors.customer_id[0]),1)):Y("",!0)])]),g("div",zn,[O(w,{label:e.$t("Description"),modelValue:s.form.description,"onUpdate:modelValue":n[6]||(n[6]=m=>s.form.description=m),errors:(I=s.errors)==null?void 0:I.description,class:"ltr:pr-6 rtl:pl-6 pb-8 w-full"},null,8,["label","modelValue","errors"]),s.form.gateway=="Stripe"?(M(),z("div",Yn,[g("label",Xn,L(e.$t("Credit or debit card")),1),O(p,{amount:t.amount,ref:"stripeCard",pk:s.publishableKey,onToken:u.tokenCreated,onLoading:n[7]||(n[7]=m=>s.loading=m),class:"stripe-card w-full mt-2 mb-6 pr-6"},null,8,["amount","pk","onToken"])])):s.form.gateway!="PayU"?(M(),Pe(v,{key:1,class:"mb-8",id:"received",modelValue:s.form.received,"onUpdate:modelValue":n[8]||(n[8]=m=>s.form.received=m),checked:s.form.received,label:e.$t("I am receiving this amount")},null,8,["modelValue","checked","label"])):Y("",!0)]),g("div",{class:G([{"rounded-b":t.modal},"px-8 py-4 bg-gray-100 border-t border-gray-200 rounded-b-md flex justify-end items-center"])},[O(S,{loading:s.sending,class:"btn-gray",type:"submit"},{default:Oe(()=>[Te(L(e.$t("create_x",{x:e.$tc("Payment")})),1)]),_:1},8,["loading"])],2)],32)],2)])],2)],2)):Y("",!0)}const rt=xe(jn,[["render",Kn]]);export{rt as default};
