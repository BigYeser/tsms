...
`);else{const p=t.ids.size-1,l=document.createTextNode(c),h=t.element.childNodes;h[p]&&t.element.removeChild(h[p]),h.length?t.element.insertBefore(l,h[p]):t.element.appendChild(l)}}}const mn=un;var pe=function(){var e=this.$createElement,n=this._self._c||e;return n("div",[n("form",{attrs:{id:"stripe-element-form"}},[n("div",{attrs:{id:"stripe-element-mount-point"}}),this._v(" "),this._t("stripe-element-errors",[n("div",{attrs:{id:"stripe-element-errors",role:"alert"}})]),this._v(" "),n("button",{ref:"submitButtonRef",staticClass:"hide",attrs:{type:"submit"}})],2)])},hn=[];pe._withStripped=!0;const fn=function(e){e&&e("data-v-4dd8360e_0",{source:`
